...
if (NOT QT_NO_CREATE_TARGETS)
    get_property(is_global TARGET Qt6::qdbuscpp2xml PROPERTY IMPORTED_GLOBAL)
    if(NOT is_global)
        set_property(TARGET Qt6::qdbuscpp2xml PROPERTY IMPORTED_GLOBAL TRUE)
    endif()
endif()

if (NOT QT_NO_CREATE_TARGETS)
    get_property(is_global TARGET Qt6::qdbusxml2cpp PROPERTY IMPORTED_GLOBAL)
    if(NOT is_global)
        set_property(TARGET Qt6::qdbusxml2cpp PROPERTY IMPORTED_GLOBAL TRUE)
    endif()
endif()
