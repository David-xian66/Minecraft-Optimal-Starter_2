# Form implementation generated from reading ui file '/Users/xyj/.npm/ssh/UI/MOS_UI.ui'
#
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/Users/xyj/.npm/ssh/UI/../picture/back.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.gridLayout_56.addItem(spacerItem16, 0, 2, 1, 1)
        self.label_43 = QtWidgets.QLabel(self.page_25)
        self.label_43.setStyleSheet("border-style:none;color:rgb(33, 33, 33);font-size: 17px;background-color: rgba(255, 255, 255, 0);")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("/Users/xyj/.npm/ssh/UI/../picture/folder.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.gridLayout_58.addItem(spacerItem17, 1, 0, 1, 1)
        ...
        self.gridLayout_56.addItem(spacerItem18, 4, 0, 1, 3)
...
"#pushButton_40::pressed{background-color: rgba(255, 0, 0, 100);}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("/Users/xyj/.npm/ssh/UI/../picture/trash_red.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.gridLayout_53.addItem(spacerItem23, 5, 0, 1, 4)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/Users/xyj/.npm/ssh/UI/../picture/settings.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("/Users/xyj/.npm/ssh/UI/../picture/folder_add.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("/Users/xyj/.npm/ssh/UI/../picture/add.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.stackedWidget_mos_right_2.addWidget(self.page_24)
...
"*/")
        ...
        self.gridLayout_34.addItem(spacerItem24, 0, 0, 1, 2)
...
"*/")
        ...
        spacerItem25 = QtWidgets.QSpacerItem(199, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_37.addItem(spacerItem25, 0, 2, 1, 2)
        spacerItem26 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_37.addItem(spacerItem26, 3, 2, 1, 1)
        ...
        self.gridLayout_37.addItem(spacerItem27, 2, 2, 1, 2)
        ...
        self.gridLayout_37.addItem(spacerItem28, 1, 2, 1, 2)
        ...
        self.gridLayout_36.addItem(spacerItem29, 1, 0, 1, 1)
        ...
        self.gridLayout_38.addItem(spacerItem30, 0, 0, 1, 1)
...
"border:2px solid rgb(0, 150, 255);")
        ...
        spacerItem31 = QtWidgets.QSpacerItem(832, 393, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.gridLayout_38.addItem(spacerItem31, 4, 0, 1, 1)
...
"*/")
        ...
        self.gridLayout_42.addItem(spacerItem32, 6, 0, 1, 2)
...
"QPushButton::pressed{background-color: rgba(255, 0, 0, 100);}")
        ...
        self.gridLayout_40.addItem(spacerItem33, 0, 0, 1, 2)
        ...
        self.gridLayout_47.addItem(spacerItem34, 1, 2, 1, 1)
...
"#pushButton_3::pressed{background-color: rgba(0, 150, 255, 51);}")
        ...
        self.gridLayout_48.addItem(spacerItem35, 0, 2, 1, 1)
...
"#pushButton_10::pressed{background-color: rgba(0, 150, 255, 51);}")
        ...
        self.gridLayout_49.addItem(spacerItem36, 0, 3, 1, 1)
        ...
        spacerItem37 = QtWidgets.QSpacerItem(796, 368, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.gridLayout_46.addItem(spacerItem37, 1, 0, 1, 1)
        ...
        self.gridLayout_45.addItem(spacerItem38, 0, 0, 1, 2)
        ...
        spacerItem39 = QtWidgets.QSpacerItem(20, 30, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.gridLayout_7.addItem(spacerItem39, 4, 0, 1, 2)
        ...
        spacerItem40 = QtWidgets.QSpacerItem(49, 13, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
...
"*/")
        ...
        spacerItem41 = QtWidgets.QSpacerItem(832, 13, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem41, 0, 0, 1, 2)
...
"*/")
        ...
        spacerItem42 = QtWidgets.QSpacerItem(199, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_25.addItem(spacerItem42, 0, 2, 1, 2)
        spacerItem43 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_25.addItem(spacerItem43, 3, 2, 1, 1)
        ...
        self.gridLayout_25.addItem(spacerItem44, 2, 2, 1, 2)
        ...
        self.gridLayout_25.addItem(spacerItem45, 1, 2, 1, 2)
        ...
        self.gridLayout_26.addItem(spacerItem46, 1, 0, 1, 1)
...
"border:2px solid rgb(0, 150, 255);")
        ...
        spacerItem48 = QtWidgets.QSpacerItem(832, 393, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.gridLayout_3.addItem(spacerItem48, 4, 0, 1, 1)
...
"*/")
        ...
        self.gridLayout_23.addItem(spacerItem49, 6, 0, 1, 2)
...
"QPushButton::pressed{background-color: rgba(255, 0, 0, 100);}")
        ...
        spacerItem50 = QtWidgets.QSpacerItem(832, 13, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_15.addItem(spacerItem50, 0, 0, 1, 2)
        ...
        spacerItem51 = QtWidgets.QSpacerItem(34, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
...
"#pushButton_3::pressed{background-color: rgba(0, 150, 255, 51);}")
        ...
        spacerItem52 = QtWidgets.QSpacerItem(34, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_17.addItem(spacerItem52, 0, 2, 1, 1)
...
"#pushButton_10::pressed{background-color: rgba(0, 150, 255, 51);}")
        ...
        spacerItem53 = QtWidgets.QSpacerItem(34, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_18.addItem(spacerItem53, 0, 3, 1, 1)
        ...
        spacerItem54 = QtWidgets.QSpacerItem(796, 368, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.gridLayout_19.addItem(spacerItem54, 1, 0, 1, 1)
        ...
        spacerItem55 = QtWidgets.QSpacerItem(832, 13, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_14.addItem(spacerItem55, 0, 0, 1, 2)
...
"")
        ...
        spacerItem56 = QtWidgets.QSpacerItem(20, 184, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.stackedWidget_mos_right_2.setCurrentIndex(1)
