...
"border:2px solid rgb(0, 150, 255);")
    ...
    def click_pushButton_home(self):
        ...
        c = "color: blue;height:35px;color: rgb(0, 150, 255);background-position: left;text-align: left;padding-right:10px;padding-left:3px;font-size: 15px;border-style:none;border-radius:8px;border:2px solid rgb(229, 228, 226);background-color: rgb(192, 192, 192);::pressed{border:2px solid rgb(0, 150, 255);}"


        self.stackedWidget_mos_right.setCurrentIndex(0)
        self.pushButton_home.setStyleSheet(c)
